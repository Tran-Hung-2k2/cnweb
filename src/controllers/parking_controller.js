...
const controller = {
    ...
    async get_all_parking(req, res) {
        try {
            ...
            return res.status(500).json(api_response(true, 'Lấy danh sách bãi đỗ xe thất bại'));
        }
    },
    ...
    async add_parking(req, res) {
        try {
            ...
            return res.status(500).json(api_response(true, 'Thêm bãi đỗ xe mới thất bại'));
        }
    },
    ...
    async update_parking(req, res) {
        try {
            ...
            console.log(error);
            return res.status(500).json(api_response(true, 'Cập nhật thông tin bãi đỗ xe thất bại'));
        }
    },
    ...
    async delete_parking(req, res) {
        try {
            ...
            return res.status(500).json(api_response(true, 'Xóa bãi đỗ xe thất bại'));
        }
    },
};
