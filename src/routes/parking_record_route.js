...
route.get('/', middleware.verify_admin, async_wrap(controller.get_all_parking_record));
route.post('/', middleware.verify_manager, async_wrap(controller.add_parking_record));
