        ...
        >
            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                ...
                <nav className="py-4 px-4 lg:px-6">
                    {/* <!-- Menu Group --> */}
                    <div>
                        <h3 className="mb-4 ml-4 text-sm font-semibold text-bodylight2">MENU</h3>
                                        ...
                                        <React.Fragment>
                                            <NavLink
                                                ...
                                                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodylight1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                                                    ...
                                                    'bg-second text-white dark:bg-meta-4'
                                                }`}
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                ...
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <NavLink
                                                            to="/"
                                                            className={({ isActive }) =>
                                                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodylight2 duration-300 ease-in-out hover:text-bodylight ' +
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <NavLink
                                                to="#"
                                                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodylight1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                                ...
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <NavLink
                                                            ...
                                                            className={({ isActive }) =>
                                                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodylight2 duration-300 ease-in-out hover:text-white ' +
                                                                (isActive && '!text-white')
                                                            }
                                                        >
                                                            Form Elements
                    ...
                    {/* <!-- Others Group --> */}
                    <div>
                        <h3 className="mb-4 ml-4 text-sm font-semibold text-bodylight2">OTHERS</h3>
